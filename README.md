...
2. Tải toàn bộ thư mục `webtrangsuc` này lên Repository vừa tạo (gồm các file `index.html`, `style.css`, `app.js`, `config.js`, `vercel.json` và toàn bộ các thư mục ảnh `sp1` đến `sp19`).
